...
Window_Base.prototype.drawCharacter = function(characterName, characterIndex, x, y) {
    var frames = characterName.match(/(F(\d+\.*\d*))/i)
     ...
     var frames2 = this._characterName.match(/(\(FF(\d+\.*\d*))/i)
     var frames=frames2||frames
    if (frames) { this.drawCharacterPoses(characterName, characterIndex, x, y, frames[2]);
    
     return };    _mog_charPoses_drawCharacter.call(this, characterName, characterIndex, x, y);
};
...
Game_CharacterBase.prototype.setPose = function() {
    ...
    if (this.isFaintPose()) {
        ...
        return this.setJumpPose();
    } else if (this.isSzPose()) {
        return this.setSzPose();
    } else if (this.isDownPose()) {
        return this.setDownPose();
    } else if (this.isIdlePose()) {
        return this.setIdlePose();
    };
    if (this.isDiagonalDefaultPose()) {
...
Game_CharacterBase.prototype.isSzPose = function() {
    return false
};
...
// * Set Jump Pose
//==============================
Game_CharacterBase.prototype.setSzPose = function() {
    return this._originalName.name
};


Game_Player.prototype.isSzPose = function() {
    var e = this.isJumpingE()
    if (e && (e._ptType == "sz" || e._qyid == 15)) {
        return true
    } else {
        return false
    }
...
// * Set Jump Pose
//==============================
Game_Player.prototype.setSzPose = function() {
    this._poses.idle[1] = this._poses.idle[2];
    var e = this.isJumpingE()
    if (e._qyid == 15) {
        return this._originalName.name + "_tz";
    } else if (e._ptType == "sz") {
        return this._originalName.name + "_sz";
    }
};
...
Game_CharacterBase.prototype.isDownPose = function() {
    if (this._downing) {
        if (Input.dir4 == 2) {
            return true
        } else {
...
// * Set Jump Pose
//==============================
Game_CharacterBase.prototype.setDownPose = function() {
    this._poses.idle[1] = this._poses.idle[2];
    return this._originalName.name + "_down";
};
